...
<!--      </el-table-column>-->
      ...
      <el-table-column label="Sku明细" align="center" width="280px" >
        ...
        <template slot-scope="scope" >
          <el-table :data="scope.row.skus" :show-header="false" :cell-style="{border:0 + 'px' }"  :row-style="{border:0 + 'px' }" >
            ...
            <el-table-column label="规格" align="left" width="100px" prop="specName" ></el-table-column>

            <el-table-column label="Sku编码" align="left" prop="specNum" width="100"/>
