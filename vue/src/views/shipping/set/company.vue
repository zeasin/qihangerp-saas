  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="平台" prop="platformId">
        <el-select v-model="queryParams.platformId" placeholder="请选择平台" @change="handleQuery">
          <el-option
...
<!--      <el-table-column label="id" align="center" prop="id" />-->
      <el-table-column label="快递公司" align="center" prop="name" />
       ...
       <el-table-column label="平台快递ID" align="center" prop="logisticsId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="平台快递ID" prop="logisticsId">
          <el-input v-model="form.logisticsId" placeholder="请输入平台快递ID" />
        </el-form-item>
...
import {
  ...
  delLogistics,
  getLogistics,
  listLogistics, pullLogisticsCompanyList,
  updateLogistics,
  updateStatus
  ...
  data() {
    return {
      ...
      rules: {
        ...
        logisticsId: [{ required: true, message: "不能为空", trigger: "blur" }],
  ...
  methods: {
    ...
    handlePull() {
      if(this.queryParams.platformId) {
       ...
       if(this.queryParams.platformId===9){
          this.$modal.msgSuccess("线下渠道请手动添加");
        }else{
         console.log('=====拉取快递公司接口=====')
         pullLogisticsCompanyList(this.queryParams.platformId).then(response => {
